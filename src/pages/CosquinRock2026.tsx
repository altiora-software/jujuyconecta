...
const CosquinRock2026 = () => {
  ...
  return (
    <Layout>
      {/* Offset para que el contenido no quede debajo de la navbar */}
      <div className="min-h-screen bg-[#050814] text-white pt-16 md:pt-20 lg:pt-24">
        {/* HERO */}
        <section
          className="relative w-full overflow-hidden min-h-[70vh] md:h-[80vh] md:min-h-[520px]"
          ...
          <div className="relative z-10 flex h-full items-center">
            <div className="mx-auto flex w-full max-w-6xl flex-col gap-8 px-4 md:flex-row md:items-end md:justify-between md:px-6 lg:px-8">
              <div className="max-w-xl">
                <p className="mb-4 text-xs uppercase tracking-[0.25em] text-orange-300">
              ...
              <div className="mt-8 w-full max-w-xs md:mt-0">
                <div className="rounded-3xl bg-black/65 p-4 backdrop-blur">
                  ...
                  <p className="mt-4 text-[0.7rem] leading-relaxed text-gray-400">
        ...
        <main className="mx-auto max-w-6xl px-4 py-10 space-y-14 md:px-6 lg:px-8">
          ...
          {/* Grilla destacada con scroll-mt para navbar */}
          <section
            id="cosquin-grilla"
          >
            <CosquinGrilla />
          ...
          <section className="space-y-8">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              <div className="rounded-2xl bg-black/40 p-5 border border-white/10 hover:border-orange-400/40 transition">
                <h3 className="mb-3 text-lg font-bold uppercase text-orange-300">
                  Colectivo
                </h3>
                <p className="text-gray-200 leading-relaxed">
                  La opción más popular para quienes van en banda. Salidas desde Jujuy
                  con trasbordo en Salta o Tucumán o directos a Córdoba. Desde la terminal
