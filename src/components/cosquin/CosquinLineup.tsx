...
const Artist: React.FC<ArtistProps> = ({ name }) => {
  ...
  return (
    <span
      className={clsx(
        "inline-flex max-w-full items-center gap-1 cursor-default select-none transition-all duration-150",
        isHeadliner
    ...
    >
      <span
        className={clsx(
          "block max-w-full break-words text-left leading-snug",
          isHeadliner
            ? "text-sm sm:text-lg md:text-xl font-black uppercase tracking-wide bg-gradient-to-tr from-orange-300 via-yellow-200 to-pink-300 bg-clip-text text-transparent drop-shadow"
    ...
    >
      ...
      <div className="relative space-y-10">
        ...
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div>
            <p className="mb-1 text-[0.65rem] uppercase tracking-[0.35em] text-orange-300">
          ...
          <a
            ...
            className="inline-flex items-center justify-center rounded-full border border-orange-400/60 px-4 sm:px-5 py-2 text-[0.6rem] sm:text-[0.7rem] font-semibold uppercase tracking-[0.2em] text-orange-300 hover:bg-orange-400 hover:text-black transition"
          >
            Sitio oficial ↗
          </a>
        </div>
        ...
        {/* GLOBALES */}
        <div className="rounded-3xl bg-[#0c1b4a]/80 border border-white/15 px-3 py-5 sm:px-6 sm:py-7 shadow-[0_20px_60px_rgba(0,0,0,0.7)] w-full">
          <p className="mb-3 text-center text-[0.7rem] sm:text-sm text-blue-100 font-semibold tracking-[0.18em] uppercase">
        ...
        <div className="grid gap-6 md:grid-cols-2 w-full">
          {/* Día 1 */}
          <div className="rounded-3xl bg-[#0c1b4a]/80 border border-white/15 px-3 py-5 sm:px-6 sm:py-7 shadow-[0_18px_50px_rgba(0,0,0,0.65)]">
            <div className="mb-3 flex flex-wrap items-center gap-2">
              <span className="inline-flex items-center rounded-full bg-black/60 px-3 py-1 text-[0.65rem] font-semibold uppercase tracking-[0.24em] text-blue-100">
                Día 1
              </span>
              <span className="text-[0.7rem] sm:text-xs font-semibold text-orange-300 uppercase tracking-[0.25em]">
                14 de febrero
              </span>
            </div>
            <p className="mb-3 text-[0.75rem] sm:text-[0.8rem] text-gray-200">
          ...
          <div className="rounded-3xl bg-[#0c1b4a]/80 border border-white/15 px-3 py-5 sm:px-6 sm:py-7 shadow-[0_18px_50px_rgba(0,0,0,0.65)]">
            <div className="mb-3 flex flex-wrap items-center gap-2">
              ...
              <span className="text-[0.7rem] sm:text-xs font-semibold text-purple-300 uppercase tracking-[0.25em]">
                15 de febrero
              </span>
            </div>
            <p className="mb-3 text-[0.75rem] sm:text-[0.8rem] text-gray-200">
